...
class EstimateParseService:
    ...
    def _rule_based_fallback(payload: EstimateParseRequest) -> EstimateParseAssessment:
        fallback = {
            "labor_totals": {"body": "14.2", "paint": "7.8"},
            "parts_total": "$1,840",
            "paint_material_total": "$420",
            "missing_fields": ["calibration requirement", "OEM procedure attachment"],
            "risk_flags": ["ADAS/calibration review may be needed"],
            "review_checklist": ["Verify labor totals", "Attach relevant OEM procedures", "Confirm supplement status"],
            "confidence": 0.74,
        }
